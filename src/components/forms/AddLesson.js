  ...
  render() {
    ...
    if (this.props.lesson != undefined) {
      ...
      state.push([
          ...
          <TextField hintText={this.state.lesson.note || 'Note pour cette lesson'}
      ...
      <Container>
        ...
        <Row>
          <Col sm={4}>
            ...
            <DefaultSelect useTo="Apprenant" data={this.props.students}
                           changeFunc={this.onChangeStudent.bind(this)}
                           defaultValue={this.state.lesson.student}/>
            <DefaultSelect useTo="Formateur" data={this.props.teachers}
